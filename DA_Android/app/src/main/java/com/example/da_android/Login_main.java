...
//                            System.out.println(posts.indexOf(UserName.getText().toString()));
                            ...
                            for (Post post : posts) {
                                ...
                                if (UserName.getText().toString().equals(post.getUsername()) == true && Password.getText().toString().equals(post.getPassword()) == true) {
                                    System.out.println("check username" + post.getUsername());
                                    String message = "Dang nhap thanh cong";
                                    Toast.makeText(Login_main.this, message, Toast.LENGTH_LONG).show();
                                    break;
                                } else if(UserName.getText().toString().equals(post.getUsername()) == true && Password.getText().toString().equals(post.getPassword()) == false) {
